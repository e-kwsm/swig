...
public:
  ...
  int classDirectorMethod(Node *n, Node *parent, String *super) {
    ...
    if (Swig_typemap_lookup("directorin", adjustedreturntypeparm, "", nullptr) && (cdesc = Getattr(adjustedreturntypeparm, "tmap:directorin:descriptor"))) {
    ...
    if ((c_ret_type = Swig_typemap_lookup("jni", n, "", nullptr))) {
      ...
      if (Swig_typemap_lookup("directorin", tp, "", nullptr) && (jdesc = Getattr(tp, "tmap:directorin:descriptor"))) {
        ...
        Swig_warning(WARN_TYPEMAP_DIRECTORIN_UNDEF,
                     ...
                     line_number,
                     "No or improper directorin typemap defined for %s for use in %s::%s (skipping director method)\n",
                     SwigType_str(c_ret_type, nullptr),
                     SwigType_namestr(c_classname),
                     SwigType_namestr(name));
        output_director = false;
      }
    ...
    if ((tm = Swig_typemap_lookup("directorin", tp, "", nullptr)) && (jdesc = Getattr(tp, "tmap:directorin:descriptor"))) {
    ...
    for (i = 0, p = l; p; ++i) {
      ...
      if ((c_param_type = Getattr(p, "tmap:jni"))) {
        ...
        if ((desc_tm = Swig_typemap_lookup("directorin", tp, "", nullptr)) && (jdesc = Getattr(tp, "tmap:directorin:descriptor")) &&
          ...
          if (!desc_tm) {
            Swig_warning(WARN_JAVA_TYPEMAP_JAVADIRECTORIN_UNDEF,
                         ...
                         line_number,
                         "No or improper directorin typemap defined for %s for use in %s::%s (skipping director method)\n",
                         SwigType_str(c_param_type, nullptr),
                         SwigType_namestr(c_classname),
                         SwigType_namestr(name));
            p = nextSibling(p);
          } else if (!jdesc) {
